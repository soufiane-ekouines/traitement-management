        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="{{ route('dashboard') }}" class="btn btn-sm mb-0 me-1 btn-primary">developers</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Use this awesome dashboard to mange your treatment.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form role="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Password"
                                        aria-label="Password" name="password" value="{{ old('password') }}" required>
                                        @error('password')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary">
                        ...
                        </script> Soft by soufiane ekouines.
                    </p>
                </div>
            </div>
        </div>
